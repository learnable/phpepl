...
$blackList  = array(
    ...
    "mkdir", "move_uploaded_file", "mysql_connect", "mysql_close",
    "parse_ini_file", "parse_str", "passthru", "pathinfo", "pcntl_exec",
    "pfsockopen", "pg_connect", "pg_close", "php_strip_whitespace",
    "phpinfo", "popen", "posix_getlogin", "posix_kill", "posix_mkfifo",
    "posix_mkfifo", "posix_setpgid", "posix_setsid", "posix_setuid",
    "posix_ttyname", "proc_close", "proc_get_status", "proc_nice",
    "proc_open", "proc_terminate", "putenv", "read_exif_data", "readfile",
    "readgzfile", "readlink", "realpath", "rename", "require",
    "require_once", "rmdir", "sha1_file", "shell_exec", "show_source",
    "stat", "symlink", "system", "tempnam", "tmpfile", "touch", "unlink",
);
