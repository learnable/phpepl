...
$blackList  = array(
    ...
    "get_cfg_var", "get_current_user", "get_meta_tags", "getcwd",
    "getenv", "getimagesize", "getlastmo", "getmygid", "getmyinode",
    "getmypid", "getmyuid", "glob", "gzfile", "gzopen", "hash_file",
    "hash_hmac_file", "hash_update_file", "header", "highlight_file",
    "image2wbmp", "imagecreatefromgif", "imagecreatefromjpeg",
    "imagecreatefrompng", "imagecreatefromwbmp", "imagecreatefromxbm",
    "imagecreatefromxpm", "imagegd", "imagegd2", "imagegif", "imagejpeg",
    "imagepng", "imagewbmp", "imagexbm", "include", "include_once",
    "ini_set", "iptcembed", "is_dir", "is_executable", "is_file",
    "is_link", "is_readable", "is_uploaded_file", "is_writable",
    "is_writeable", "lchgrp", "lchown", "link", "linkinfo", "lstat",
    "mail", "md5_file", "mkdir", "move_uploaded_file", "mysql_connect",
    "mysql_close", "parse_ini_file", "parse_str", "passthru", "pathinfo",
    "pcntl_exec", "pfsockopen", "pg_connect", "pg_close",
    ...
    "realpath", "rename", "require", "require_once", "rmdir",
    "sha1_file", "shell_exec", "show_source", "stat", "symlink",
    "system", "tempnam", "tmpfile", "touch", "unlink",
);
